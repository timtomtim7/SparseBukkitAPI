...
//	}
	...
	private net.minecraft.server.v1_9_R1.ItemStack getItemHandle(CraftItemStack item)
	{
		...
		try
		{
			return (net.minecraft.server.v1_9_R1.ItemStack) itemHandleField.get(item);
	...
	public void setItemNBT(ItemStack item, Compound compound)
	{
		...
		net.minecraft.server.v1_9_R1.ItemStack handle = getItemHandle(((CraftItemStack)item));
