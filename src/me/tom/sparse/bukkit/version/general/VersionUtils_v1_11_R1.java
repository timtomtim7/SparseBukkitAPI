...
public class VersionUtils_v1_11_R1 implements VersionUtils
{
...
//	}
	...
	private net.minecraft.server.v1_11_R1.ItemStack getItemHandle(CraftItemStack item)
	{
		...
		try
		{
			return (net.minecraft.server.v1_11_R1.ItemStack) itemHandleField.get(item);
	...
	public void setItemNBT(ItemStack item, Compound compound)
	{
		...
		net.minecraft.server.v1_11_R1.ItemStack handle = getItemHandle(((CraftItemStack)item));
	...
	{
		return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_11_R1.ItemStack((NBTTagCompound) compoundToNMSCompound(compound)));
	}
