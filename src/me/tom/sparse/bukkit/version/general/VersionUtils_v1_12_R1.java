...
public class VersionUtils_v1_12_R1 implements VersionUtils
{
...
//	}
	...
	private Object nbtBaseToObject(NBTBase o)
	{
		switch(o.getTypeId())
		{
			...
			case 6: return ((NBTTagDouble)o).asDouble();
			...
			case 9:
				...
				for(int i = 0; i < list.size(); i++)
					listResult.add(nbtBaseToObject(list.i(i)));
				return listResult;
			case 10:
	...
	private net.minecraft.server.v1_12_R1.ItemStack getItemHandle(CraftItemStack item)
	{
		...
		try
		{
			return (net.minecraft.server.v1_12_R1.ItemStack) itemHandleField.get(item);
	...
	public void setItemNBT(ItemStack item, Compound compound)
	{
		...
		net.minecraft.server.v1_12_R1.ItemStack handle = getItemHandle(((CraftItemStack)item));
	...
	{
		return CraftItemStack.asBukkitCopy(new net.minecraft.server.v1_12_R1.ItemStack((NBTTagCompound) compoundToNMSCompound(compound)));
	}
