...
public class VersionUtils_v1_8_R1 implements VersionUtils
{
	...
	public void sendTitle(Player player, String title, String subtitle, int fadeIn, int stay, int fadeOut)
	{
		...
		if(title != null)
			handle.playerConnection.sendPacket(new PacketPlayOutTitle(EnumTitleAction.TITLE, CraftChatMessage.fromString(title)[0]));
		if(subtitle != null)
			handle.playerConnection.sendPacket(new PacketPlayOutTitle(EnumTitleAction.SUBTITLE, CraftChatMessage.fromString(subtitle)[0]));
...
//	}
	...
	private net.minecraft.server.v1_8_R1.ItemStack getItemHandle(CraftItemStack item)
	{
		...
		try
		{
			return (net.minecraft.server.v1_8_R1.ItemStack) itemHandleField.get(item);
	...
	public void setItemNBT(ItemStack item, Compound compound)
	{
		...
		net.minecraft.server.v1_8_R1.ItemStack handle = getItemHandle(((CraftItemStack)item));
	...
	{
		return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_8_R1.ItemStack.createStack((NBTTagCompound) compoundToNMSCompound(compound)));
	}
