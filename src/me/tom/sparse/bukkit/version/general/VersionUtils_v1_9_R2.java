...
public class VersionUtils_v1_9_R2 implements VersionUtils
{
...
//	}
	...
	private net.minecraft.server.v1_9_R2.ItemStack getItemHandle(CraftItemStack item)
	{
		...
		try
		{
			return (net.minecraft.server.v1_9_R2.ItemStack) itemHandleField.get(item);
	...
	public void setItemNBT(ItemStack item, Compound compound)
	{
		...
		net.minecraft.server.v1_9_R2.ItemStack handle = getItemHandle(((CraftItemStack)item));
	...
	{
		return CraftItemStack.asBukkitCopy(net.minecraft.server.v1_9_R2.ItemStack.createStack((NBTTagCompound) compoundToNMSCompound(compound)));
	}
